<?php 
	...
	if ($lista[0]!=NULL){
		...
		$miconexion->consulta("insert into servicios_usuarios values('','1','$ides','$cons','PENDIENTE','$fec','$dire','')");
		$res1=$miconexion->consulta("select * from servicios where id_servicio='1'");
